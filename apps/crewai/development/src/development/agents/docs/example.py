...
def main():
    ...
    try:
        ...
        workspace_root = current_file.parent.parent.parent.parent.parent.parent.parent  # Navigate up to monorepo root
        ...
        discussion_category_id = "DIC_kwDON4sFNc4Cm7FL"  # Replace with your GitHub Discussions category ID
